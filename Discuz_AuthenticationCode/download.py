...
class Discuz():
    def __init__(self):
        ...
        # self.url = 'file:///home/hucl/%E4%B8%8B%E8%BD%BD/discuz/index.php?label='
        self.url = 'http://www.raygift.cn/index.php?/label='
    ...
    def download_discuz(self, nums=100):
        """
        下载验证码图片
        Parameters:
            nums:下载的验证码图片数量
